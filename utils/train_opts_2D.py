...
# Experiment
parser.add_argument('--exp', type=str, default="experiment", help="Name (description) of the experiment to run.")
parser.add_argument('--video_suffix', type=str,choices=['_side', '_top'], default='_side')
...
parser.add_argument('--data_path', type=str, default=os.path.join("data",'APAS',"frames"),
                    help="Path to data folder, which contains the extracted images for each video. "
                         "One subfolder per video.")
parser.add_argument('--transcriptions_dir', type=str, default=os.path.join("data","APAS","transcriptions_gestures"),
