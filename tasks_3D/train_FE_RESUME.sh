...
# JIGSAWS:          for SPLIT in {0..7}; do ARCH=X3D; ARCH_SIZE=L; DATASET=JIGSAWS; TASK=gestures; echo "ARCH-SIZE=${ARCH}-${ARCH_SIZE},DATASET=${DATASET}, TASK=${TASK}, SPLIT=${SPLIT}"; sbatch --export=ARCH=${ARCH},ARCH_SIZE=${ARCH_SIZE},DATASET=${DATASET},TASK=${TASK},SPLIT=${SPLIT} ./train_FE_RESUME.sh; done
# VTS:              for SPLIT in {0..4}; do ARCH=X3D; ARCH_SIZE=L; DATASET=VTS; TASK=gestures; echo "ARCH-SIZE=${ARCH}-${ARCH_SIZE},DATASET=${DATASET}, TASK=${TASK}, SPLIT=${SPLIT}"; sbatch --export=ARCH=${ARCH},ARCH_SIZE=${ARCH_SIZE},DATASET=${DATASET},TASK=${TASK},SPLIT=${SPLIT} ./train_FE_RESUME.sh; done
# MultiBypass140:   for SPLIT in {0..4}; do ARCH=X3D; ARCH_SIZE=L; DATASET=MultiBypass140; TASK=steps; echo "ARCH-SIZE=${ARCH}-${ARCH_SIZE},DATASET=${DATASET}, TASK=${TASK}, SPLIT=${SPLIT}"; sbatch --export=ARCH=${ARCH},ARCH_SIZE=${ARCH_SIZE},DATASET=${DATASET},TASK=${TASK},SPLIT=${SPLIT} ./train_FE_RESUME.sh; done
# MultiBypass140:   for SPLIT in {0..4}; do ARCH=X3D; ARCH_SIZE=L; DATASET=MultiBypass140; TASK=phases; echo "ARCH-SIZE=${ARCH}-${ARCH_SIZE},DATASET=${DATASET}, TASK=${TASK}, SPLIT=${SPLIT}"; sbatch --export=ARCH=${ARCH},ARCH_SIZE=${ARCH_SIZE},DATASET=${DATASET},TASK=${TASK},SPLIT=${SPLIT} ./train_FE_RESUME.sh; done
# SAR_RARP50:       for SPLIT in {0..4}; do ARCH=X3D; ARCH_SIZE=L; DATASET=SAR_RARP50; TASK=gestures; echo "ARCH-SIZE=${ARCH}-${ARCH_SIZE},DATASET=${DATASET}, TASK=${TASK}, SPLIT=${SPLIT}"; sbatch --export=ARCH=${ARCH},ARCH_SIZE=${ARCH_SIZE},DATASET=${DATASET},TASK=${TASK},SPLIT=${SPLIT} ./train_FE_RESUME.sh; done#-------------------------------------------------
if [ ${ARCH}  == "X3D" ]; then
