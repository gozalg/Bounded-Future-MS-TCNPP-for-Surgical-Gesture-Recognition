...
# VTS-gestures:             CLIP_LENGTH_PAST=15; CLIP_LENGTH_FUTURE=$((15-CLIP_LENGTH_PAST)); W_MAX_LIST=(2 3 6 7 8 10 12); for R_N in {6..6}; do for LAYERS_N in {10..10}; do for W_MAX in "${W_MAX_LIST[@]}"; do W_MAX=${W_MAX}; BACKBONE=EfficientNetV2-M; DATASET=VTS;               TASK=gestures;  echo "BACKBONE=${BACKBONE}, R_N=${R_N}, LAYERS_N=${LAYERS_N}, W_MAX=${W_MAX}, DATASET=${DATASET}, TASK=${TASK}, CLIP_LENGTH_PAST=${CLIP_LENGTH_PAST}, CLIP_LENGTH_FUTURE=${CLIP_LENGTH_FUTURE}"; export CLIP_LENGTH_PAST=${CLIP_LENGTH_PAST}; export CLIP_LENGTH_FUTURE=${CLIP_LENGTH_FUTURE}; export R_N=${R_N}; export LAYERS_N=${LAYERS_N}; export W_MAX=${W_MAX}; export BACKBONE=${BACKBONE}; export DATASET=${DATASET}; export TASK=${TASK}; sbatch ./BF-MS-TCN_train.sh; done; done; done;
# JIGSAWS-gestures:         CLIP_LENGTH_PAST=15; CLIP_LENGTH_FUTURE=$((15-CLIP_LENGTH_PAST)); W_MAX_LIST=(2 3 6 7 8 10 12); for R_N in {3..9}; do for LAYERS_N in {8..10}; do for W_MAX in "${W_MAX_LIST[@]}"; do W_MAX=${W_MAX}; BACKBONE=X3D-L; DATASET=JIGSAWS;           TASK=gestures;  echo "BACKBONE=${BACKBONE}, R_N=${R_N}, LAYERS_N=${LAYERS_N}, W_MAX=${W_MAX}, DATASET=${DATASET}, TASK=${TASK}, CLIP_LENGTH_PAST=${CLIP_LENGTH_PAST}, CLIP_LENGTH_FUTURE=${CLIP_LENGTH_FUTURE}"; export CLIP_LENGTH_PAST=${CLIP_LENGTH_PAST}; export CLIP_LENGTH_FUTURE=${CLIP_LENGTH_FUTURE}; export R_N=${R_N}; export LAYERS_N=${LAYERS_N}; export W_MAX=${W_MAX}; export BACKBONE=${BACKBONE}; export DATASET=${DATASET}; export TASK=${TASK}; sbatch ./BF-MS-TCN_train.sh; done; done; done;
# MultiBypass140-Steps:     CLIP_LENGTH_PAST=15; CLIP_LENGTH_FUTURE=$((15-CLIP_LENGTH_PAST)); W_MAX_LIST=(2 3 6 7 8 10 12); for R_N in {6..6}; do for LAYERS_N in {10..10}; do for W_MAX in "${W_MAX_LIST[@]}"; do W_MAX=${W_MAX}; BACKBONE=EfficientNetV2-M; DATASET=MultiBypass140;    TASK=steps;     echo "BACKBONE=${BACKBONE}, R_N=${R_N}, LAYERS_N=${LAYERS_N}, W_MAX=${W_MAX}, DATASET=${DATASET}, TASK=${TASK}, CLIP_LENGTH_PAST=${CLIP_LENGTH_PAST}, CLIP_LENGTH_FUTURE=${CLIP_LENGTH_FUTURE}"; export CLIP_LENGTH_PAST=${CLIP_LENGTH_PAST}; export CLIP_LENGTH_FUTURE=${CLIP_LENGTH_FUTURE}; export R_N=${R_N}; export LAYERS_N=${LAYERS_N}; export W_MAX=${W_MAX}; export BACKBONE=${BACKBONE}; export DATASET=${DATASET}; export TASK=${TASK}; sbatch ./BF-MS-TCN_train.sh; done; done; done;
# MultiBypass140-phases:    CLIP_LENGTH_PAST=15; CLIP_LENGTH_FUTURE=$((15-CLIP_LENGTH_PAST)); W_MAX_LIST=(2 3 6 7 8 10 12); for R_N in {6..6}; do for LAYERS_N in {10..10}; do for W_MAX in "${W_MAX_LIST[@]}"; do W_MAX=${W_MAX}; BACKBONE=EfficientNetV2-M; DATASET=MultiBypass140;    TASK=phases;    echo "BACKBONE=${BACKBONE}, R_N=${R_N}, LAYERS_N=${LAYERS_N}, W_MAX=${W_MAX}, DATASET=${DATASET}, TASK=${TASK}, CLIP_LENGTH_PAST=${CLIP_LENGTH_PAST}, CLIP_LENGTH_FUTURE=${CLIP_LENGTH_FUTURE}"; export CLIP_LENGTH_PAST=${CLIP_LENGTH_PAST}; export CLIP_LENGTH_FUTURE=${CLIP_LENGTH_FUTURE}; export R_N=${R_N}; export LAYERS_N=${LAYERS_N}; export W_MAX=${W_MAX}; export BACKBONE=${BACKBONE}; export DATASET=${DATASET}; export TASK=${TASK}; sbatch ./BF-MS-TCN_train.sh; done; done; done;
# SAR_RARP50-gestures:      CLIP_LENGTH_PAST=15; CLIP_LENGTH_FUTURE=$((15-CLIP_LENGTH_PAST)); W_MAX_LIST=(2 3 6 7 8 10 12); for R_N in {6..6}; do for LAYERS_N in {10..10}; do for W_MAX in "${W_MAX_LIST[@]}"; do W_MAX=${W_MAX}; BACKBONE=EfficientNetV2-M; DATASET=SAR_RARP50;        TASK=gestures;  echo "BACKBONE=${BACKBONE}, R_N=${R_N}, LAYERS_N=${LAYERS_N}, W_MAX=${W_MAX}, DATASET=${DATASET}, TASK=${TASK}, CLIP_LENGTH_PAST=${CLIP_LENGTH_PAST}, CLIP_LENGTH_FUTURE=${CLIP_LENGTH_FUTURE}"; export CLIP_LENGTH_PAST=${CLIP_LENGTH_PAST}; export CLIP_LENGTH_FUTURE=${CLIP_LENGTH_FUTURE}; export R_N=${R_N}; export LAYERS_N=${LAYERS_N}; export W_MAX=${W_MAX}; export BACKBONE=${BACKBONE}; export DATASET=${DATASET}; export TASK=${TASK}; sbatch ./BF-MS-TCN_train.sh; done; done; done;
#--------------------- User ----------------------
#------------------------------
